    ...
    <div className="relative min-h-[300px] xs:min-h-[400px] sm:min-h-[500px] md:h-[600px]">
      <div className="absolute inset-0">
        <img
          ...
          alt="Abdul Syed - Consultant Breast Surgeon in Essex, UK operating theatre"
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
        <div className="max-w-2xl text-white">
          ...
          <p className="text-base sm:text-lg md:text-xl mb-6 md:mb-8">
            Mr Abdul Syed is a consultant breast surgeon in Essex, UK with over 1,500 successful surgeries. Specializing in oncoplastic breast surgery with compassionate, patient-centred care and the latest surgical advances.
          </p>
