    ...
    <div className="relative min-h-[300px] xs:min-h-[400px] sm:min-h-[500px] md:h-[600px]">
      <div className="absolute inset-0">
        <img
          ...
          alt="Abdul Syed - Best Breast Surgeon in UK operating theatre in Essex"
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
        <div className="max-w-2xl text-white">
          <h1 className="text-lg xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6 md:mb-8">
            Best Breast Surgeon in UK & Essex
            <p className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-2">Abdul Syed Breast Surgeon (MBBS, MRCSEd, FRCS)</p>
          </h1>
          <p className="text-base sm:text-lg md:text-xl mb-6 md:mb-8">
            Recognized as one of the best breast surgeons in the UK, Mr Abdul Syed is a leading breast surgeon in Essex with over 1,500 successful surgeries. Specializing in oncoplastic breast surgery with compassionate, patient-centred care and the latest surgical advances.
          </p>
