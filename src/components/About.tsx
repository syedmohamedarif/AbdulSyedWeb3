      ...
      <Container>
        <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12">
          <div className="lg:w-1/2">
            <img
              src= '/images/half.jpg'
              alt="Abdul Syed - Consultant Breast Surgeon in Essex providing expert consultation"
              className="rounded-lg shadow-lg w-full"
            />
          </div>
          <div className="lg:w-1/2">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              About Mr Abdul Syed - Consultant Breast Surgeon
            </h2>
            <p className="text-lg text-gray-600 mb-6">
              As a consultant breast surgeon in Essex, Mr Abdul Syed is dedicated to 
