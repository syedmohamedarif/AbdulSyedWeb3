  ...
  return (
    <div className={cn("bg-white rounded-lg shadow-lg p-8", className)} {...props}>
      <p className="space-y-4 text-lg-gray-600 mb-6">
        As a Consultant Breast Surgeon with over nine years of experience, I specialise in Oncoplastic Breast Surgery, dedicating my career to delivering high-quality comprehensive breast care services. Recognized as one of the best breast surgeons in the UK, I am committed to providing exceptional care to patients throughout Essex and the United Kingdom.
      </p>
      <p className="space-y-4 text-lg-gray-600 mb-6">
        My NHS practice is focused on providing exceptional outpatient services and performing surgeries at Southend University Hospital. I also support the plastic surgery unit at Broomfield Hospital, particularly for patients in need of reconstructive breast surgeries. As a leading breast surgeon in Essex, I ensure that all patients receive the highest standard of care.
      </p>
      <p className="space-y-4 text-lg-gray-600 mb-6">
